...
public class ConsolaOlimpicos
{
	...
	{
		System.out.println("\n" + "El país que representa el atleta" + "\n");
		String nombre_atleta = input("Escriba el nombre del atleta que desea consultar");
		Atleta atleta = calculadora.buscarAtleta(nombre_atleta);
		System.out.println("El atleta es de: " + atleta.darPais().darNombre() + "\n");
	}
